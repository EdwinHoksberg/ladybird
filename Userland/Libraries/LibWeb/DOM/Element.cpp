...
bool Element::check_visibility(Optional<CheckVisibilityOptions> options)
{
    ...
    auto const skipped_contents_due_to_content_visibility_auto = false; // FIXME: Currently we do not skip any content if content-visibility is auto: https://drafts.csswg.org/css-contain-2/#proximity-to-the-viewport
